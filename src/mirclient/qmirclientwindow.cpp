...
Spec makeSurfaceSpec(QWindow *window, QMirClientInput *input, MirPixelFormat pixelFormat, MirConnection *connection)
{
...
MirSurface *createMirSurface(QWindow *window, int mirOutputId, QMirClientInput *input, MirPixelFormat pixelFormat,
